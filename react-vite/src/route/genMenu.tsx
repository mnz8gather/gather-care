...
interface CustomIndexRouteObject extends IndexRouteObject, RouteObjectExtra {
  // IndexRouteObject 中没有 children, 遵循 IndexRouteObject 的约束
}

interface CustomNonIndexRouteObject extends NonIndexRouteObject, RouteObjectExtra {
  children?: InnerCustomRouteObject[];
}

type InnerCustomRouteObject = CustomIndexRouteObject | CustomNonIndexRouteObject;

export type CustomRouteObject = InnerCustomRouteObject;

type MenuItem = Required<MenuProps>['items'][number];

export function genMenu(routes: CustomRouteObject[]): MenuItem[] {
  let temp: MenuItem[] = [];
